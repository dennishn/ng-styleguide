...
const commonConfig = require('./webpack.common.js'); // the settings that are shared to prod and dev
		...
		plugins: [
			...
			new DllBundlesPlugin({
				bundles      : {
					...
					vendor   : ['@angular/platform-browser', '@angular/platform-browser-dynamic', '@angular/core', '@angular/forms', '@angular/http', '@angular/router', '@angularclass/hmr', 'rxjs',]
				},
			...
			new LoaderOptionsPlugin({
				...
				options: {
					...
					sassLoader: {
						includePaths: [helpers.root('node_modules'), helpers.root('src'),],
					},
				}
			}),
