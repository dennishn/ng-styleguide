...
module.exports = function(options) {
	...
	return {
		...
		plugins: [
			 ...
			 * Description: Shares shared code between the pages.
			 * It identifies shared modules and put them into a commons chunk.
			 *
			...
			new ContextReplacementPlugin(// The (\\|\/) piece accounts for path separators in *nix and Windows
				/angular(\\|\/)core(\\|\/)src(\\|\/)linker/, helpers.root('src'), // location of your src
				{
